...
## 🔁 Retrospectiva
El proyecto es una torre donde se apilan copas y tapas, cada una con sus propias reglas: la OpenerCup elimina todas las tapas al entrar, la HierarchicalCup se va al fondo y no puede salir, y tapas como FearfulLid o GluedLid se quedan pegadas para siempre. Lo más complicado fue la lógica de anidamiento cuando una copa cabe dentro de otra la altura no suma completa y el backtracking de TowerContest. Con Sergio nos coordinamos bien desde el principio, aunque pasar de BlueJ a Maven nos generó varios conflictos de paquetes que nos tomó un buen rato resolver. Los diagramas en Astah quedaron incompletos. Lo que más nos costó fue lograr que los tests no abrieran la ventana gráfica, porque la lógica y lo visual estaban muy mezclados, y lo que más aprendimos fue cómo estructurar jerarquías de clases para que cada objeto maneje su propio comportamiento sin que nadie más tenga que saber cómo lo hace.
