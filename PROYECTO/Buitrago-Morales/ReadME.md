...
## 🔁 Retrospectiva
El proyecto consiste en una torre de apilamiento de copas y tapas donde cada elemento tiene reglas propias de entrada, salida y efecto sobre los demás desde la OpenerCup que elimina todas las tapas al entrar, hasta la HierarchicalCup que se hunde al fondo y no puede salir, pasando por tapas como FearfulLid o GluedLid que se pegan permanentemente. La lógica de anidamiento (copas que caben dentro de otras reduciendo la altura efectiva) y el algoritmo de backtracking en TowerContest fueron los retos algorítmicos más exigentes. El trabajo con Sergio fue fluido y bien coordinado, aunque integrarnos en Maven tras trabajar en BlueJ generó conflictos de paquetes que tomaron tiempo resolver. Las deudas más claras son los diagramas en Astah, que quedaron incompletos, y la falta de refactorización en métodos de Tower que crecieron demasiado. Lo que más aprendimos fue diseño OOP real: construir jerarquías con Cup y Lid como abstracciones y dejar que cada subtipo resuelva su propio comportamiento mediante polimorfismo. Lo más difícil fue separar la lógica de la capa gráfica para lograr tests completamente invisibles.
